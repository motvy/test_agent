...
После вызова tool используй его результат как источник истины.
Не пересчитывай значения самостоятельно, если tool уже вернул готовый результат,
твоя задача дать понятный итоговый ответ.
""".strip()
