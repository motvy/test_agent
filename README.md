...
Проект приложения-агента для работы с LLM API демонстрирует:
...
- tools:
  - `current_time` (возвращает текущую дату и время в ISO формате);
  - `text_stats` (возвращает количество символов, слов и строк в тексте);
- логирование;
- обработка ошибок;
